        ...
        <div className={styles.headerWrapper}>
          <div className={styles.headerText}>
            <h1 className={styles.title}>
              <span className={styles.gradientText}>Excellence Sélectionnée</span>
            </h1>
            <p className={styles.subtitle}>Les mieux notés par nos lecteurs</p>
          </div>
              ...
              <div className={styles.cardInner}>
                <div className="space-y-3 md:space-y-4">
                  ...
                  <p className={styles.bookDesc}>
                    Le dernier chef-d'œuvre de Jane McLane remet en question la narration conventionnelle. Explorez des récits transformateurs...
                  </p>
                </div>
